...
class Data {
  ...
  factory Data.fromJson(Map<String, dynamic> json) =>
      Data(
        ads: json["ads"] == null ? [] : List<AdsModelDatum>.from(
            json["ads"]!.map((x) => AdsModelDatum.fromJson(x))),

        lifeExam: json["life_exam"] == null ? null : LifeExam.fromJson(
            json["life_exam"]),
  ...
  Map<String, dynamic> toJson() =>
      {
        "ads": ads == null ? [] : List<dynamic>.from(
            ads!.map((x) => x.toJson())),
...
class AdsModelDatum {
  ...
  factory AdsModelDatum.fromJson(Map<String, dynamic> json) =>
      AdsModelDatum(
        id: json["id"],
        link: json["link"],
        type: json["type"],
...
class LifeExam {
  ...
  factory LifeExam.fromJson(Map<String, dynamic> json) =>
      LifeExam(
        id: json["id"],
        name: json["name"],
        dateExam: json["date_exam"] == null ? null : DateTime.parse(
            json["date_exam"]),
  ...
  Map<String, dynamic> toJson() =>
      {
        "id": id,
        "name": name,
        "date_exam": "${dateExam!.year.toString().padLeft(4, '0')}-${dateExam!
            .month.toString().padLeft(2, '0')}-${dateExam!.day.toString()
            .padLeft(2, '0')}",
        ...
        "created_at": "${createdAt!.year.toString().padLeft(
            4, '0')}-${createdAt!.month.toString().padLeft(2, '0')}-${createdAt!
            .day.toString().padLeft(2, '0')}",
        "updated_at": "${updatedAt!.year.toString().padLeft(
            4, '0')}-${updatedAt!.month.toString().padLeft(2, '0')}-${updatedAt!
            .day.toString().padLeft(2, '0')}",
      };
}
