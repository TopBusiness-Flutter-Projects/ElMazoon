...
import 'package:elmazoon/feature/mainscreens/profilePage/presentation/widgets/customAppbar.dart';
          ...
          child: Column(
            children: [
              InkWell(
                  ...
                  child: ProfileItemWidget(image: ImageAssets.usereditIcon, title: 'register_paper_exam'.tr(), subTitle: 'register_data_enter_exam'.tr())),
             const SizedBox(height: 30,),
              InkWell(
                  onTap: () {
                    Navigator.pushNamed(context, Routes.myDegreeRoute);
                  },
                  child: ProfileItemWidget(image: ImageAssets.degreeIcon, title: 'mygards_rate'.tr(), subTitle: 'grades_performance'.tr())),
              const SizedBox(height: 30,),
